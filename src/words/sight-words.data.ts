// Standard Dolch sight word lists (grouped by grade level) plus the Fry
// Instant Words (grouped as fry-1..fry-10, 100 words each — the classic
// "First Hundred" through "Tenth Hundred", ordered by frequency).
...
export const SIGHT_WORDS: Record<string, string[]> = {
  ...
  '1st': [
    ...
    'just', 'know', 'let', 'live', 'may', 'of', 'old', 'once', 'open',
    'over', 'put', 'round', 'some', 'stop', 'take', 'thank', 'them', 'then',
...
export type GradeLevel = keyof typeof SIGHT_WORDS;
